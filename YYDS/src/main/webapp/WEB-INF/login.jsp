...
<div id="container">
    <div id="cover" class="rt" style="height:350px">
        <form id="login-form" method="post" name="form1">
            <div class="txt" style="height:355px">
                ...
                <div class="text" style="position:relative">
                    <input type="text" placeholder="请输入您的验证码" name="code" required/>
                    <span><img style="position:absolute;top:15px;right:0px;" src="${basePath}/user/code.do" onclick="this.src='${basePath}/user/code.do?='+new Date().getTime()"></span><br>
