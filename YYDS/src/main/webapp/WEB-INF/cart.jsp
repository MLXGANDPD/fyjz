        ...
        <div id="box" >
            <div id="content_box">
                <div class="imfor_top">
                 ...
                 <c:forEach items="${cart_list}" var="ll" >
                  <div class="imfor">
                    <div class="check">
                        <div class="Each">
                            <span class="normal">
                     ...
                     <!--动态的显示页面上的数据   根据用户的id 去查询 -->
                    
                    <div class="pudc">
                        <div class="pudc_information" id="${ll.id}">
                            <!-- 商品的图片 -->
                            <img src="${basePath}${ll.goodsImage}" style="width:80px; height:80px" class="lf"/>
                            <input type="hidden" name="" value="">
                         <span class="des lf">
                                         ${ll.goodsTitle}
                              
                        </span>
                            <p class="col lf"><span>颜色：</span><span class="color_des">黑色 <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des">乾坤科技专享价</p>
                        <p class="pices_information"><b>￥</b><span>${ll.goodsPrice}</span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${ll.num}" /><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${ll.goodsPrice}*${ll.num}</span>
                    </div>
                    <div class="del">
                        <!-- <div>
