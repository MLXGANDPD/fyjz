...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
        <div class="rs_header">
            <span class="rs_header_active"><a href="${basePath}/address/toMyinforHTML.do">我的信息</a></span>
            <span><a href="${basePath}/address/toUpdateHTML.do">安全管理</a></span>
        </div>
        ...
        <div class="rs_content">
            ...
            <div class="rs_content_headPortrait">
	                ...
	                <img alt="" id="img" width="50px" height="50px" src="D:/ykt/ykt/yktt/apache-tomcat-7.0.67/wtpwebapps/fyjz_retailers${u.image}"/><!--src="../images/personage/touxiang.png" -->
	               	<input type="hidden" name="iconPic" value="" id="iconPic">
	                <input type="file" id="pic" onchange="getImage()"/><!-- 更改头像class="change_headPortrait same_click" data-toggle="modal" data-target="#avatar-modal" -->
	         </div>
            <!--用户名-->
            <div class="rs_content_username">
                <span class="same">用户名：</span>
                <span class="same rs_username" id="uname">${u.userName}</span>
            ...
            <div class="rs_content_sex">
                ...
                <span class="man selected" id="usex">
...
<div class="foot_bj">
    <div id="foot">
        <div class="lf" id="if">
             ...
             <img id="img" alt=""  src="../images/footTxt/1.png">
             <img id="img" alt=""  src="../images/footTxt/2.png">
             <img id="img" alt=""  src="../images/footTxt/3.png">
             <img id="img" alt=""  src="../images/footTxt/4.png">
             <img id="img" alt=""  src="../images/footTxt/5.png">
             <img id="img" alt=""  src="../images/footTxt/6.png">
             <img id="img" alt=""  src="../images/footTxt/7.png">
             <img id="img" alt=""  src="../images/footTxt/8.png">
        </div>
...
<script type="text/javascript">
	function getImage(){
		...
		fd.append("file",file);
		$.ajax({
			url:"${basePath}/address/toupload.do",     //请求地址
			...
			success:function(result){
				//将图片渲染到页面
				$("#img").attr("src","${basePath}"+result.date);
	...
	function save_change(){
		...
		var image=$("#img").val();
		$.ajax({
			url:"${basePath}/address/saveChage.do",//请求路径
			dataType:"json",//服务器响应类型 
			type:"get",//请求方式
			data:{"name":name,"sex":sex,"phone":phone,"email":email,"image":image},
			
			success:function(result){
				if(result.state==1){
					console.log("ool");
					windows.herf="${basePath}/address/toMyinforHTML.do";
					alert("保存成功！！");
				}else{
					alert("保存失败！！");
				}
