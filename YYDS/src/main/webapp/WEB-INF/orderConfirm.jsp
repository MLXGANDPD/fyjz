...
<div id="container" class="clear">
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <c:forEach items="${map.cart_list}" var="ll" >
            
            <ul class="item_detail">
                <li class="p_info">
                    <b><img src="${basePath}${ll.goodsImage}" style="width:80px; height:80px"/></b>
                ...
                <li class="p_price">
                    <i>乾坤科技专属价</i>
                    <br/>
                    <span class="pro_price">￥<span class="ppp_price">${ll.goodsPrice}</span></span>
                </li>
                <li class="p_count">X<span>${ll.num}</span></li>
                <li class="p_tPrice">￥<span>${ll.goodsPrice}*${ll.num}</span></li>
            </ul>
             </c:forEach>
        </div>
    </form>
