...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img style="width:450px;height:350px;" id="mImg" src="${basePath}${good.image}"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <div class="shops" style="width: 600px">
            ...
            <a href="#" class="shop" style="text-align: left;margin-left: 7px" id="cart"><img src="../images/product_detail/product_detail_img7.png" alt=""/>购物车</a><span>&nbsp;&nbsp;</span>
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function () {
		...
		var url="${basePath}/cart/addGoodDate.do";
    ...
    //点击购物车事件
	$("#cart").click(function(){
		location.href="${basePath}/cart/showGoodDate.do";
	})    
    
    
    /**添加到收藏**/
    $("#collects").click(function (e){
        e.preventDefault();
        getPro();
          //如果未选择，请选择商品信息
		if (!color || !norms ) {
    ...
    $("#collect").click(function () {
		...
		var price=$("#price").val();
		var params={"goodsId":id,"num":num,"goodsTitle":title,"goodsPrice":price,"goodsImage":image};
		var url="${basePath}/cart/favorites.do";
		$.post(url,params,function(result){
			if(result.state==1){
				//添加成功
				alert("收藏成功");
